...
\nonumber I_{l_d}(r_d)=&\frac{4\pi^{3/2}}{k_dr_d\,(2l+1)}\sum_{l_p}\sqrt{(2l_p+1)(2l_d+1)}\langle l_d\,m\,l_p\,0\,|\,l\,0\rangle\\
...
\bar U^L_F(r_p)=\frac{1}{4\pi}\sum_{l'} B_{l'}(r_p)\int e^{i\mathbf k_0(r_p)\mathbf r_p}Y_0^{l'}(\hat r_p)\,d\Omega_p,
 ...
 \bar U^L_F(r_p)=\sum_{l'}\sqrt{\frac{2l'+1}{4\pi}} B_{l'}(r_p)j_{l'}(k_0(r_p) \,r_p),
 \end{equation} 
